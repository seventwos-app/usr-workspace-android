...
class SecureBackupEnterRecoveryKeyPresenterTest {
    ...
    fun `present - enter recovery key`() = runTest {
        ...
        moleculeFlow(RecompositionMode.Immediate) {
            ...
            val initialState = awaitItem()
            initialState.eventSink(SecureBackupEnterRecoveryKeyEvent.OnRecoveryKeyChange("1234"))
            ...
            withRecoveryKeyState.eventSink(SecureBackupEnterRecoveryKeyEvent.Submit)
            ...
            errorState.eventSink(SecureBackupEnterRecoveryKeyEvent.ClearDialog)
            ...
            clearedState.eventSink(SecureBackupEnterRecoveryKeyEvent.Submit)
