...
open class JoinRoomStatePreviewParam : PreviewParameterProvider<JoinRoomState> {
...
fun aLoadedContentState(
    ...
    name: String? = "Seventwos Workspace android",
    alias: RoomAlias? = RoomAlias("#exa:matrix.org"),
    topic: String? = "Seventwos Workspace is a secure, private and decentralized messenger.",
