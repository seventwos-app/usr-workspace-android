...
open class ChangeServerStatePreviewParam : PreviewParameterProvider<ChangeServerState> {
...
fun aChangeServerState(
    changeServerAction: AsyncData<MatrixHomeServerDetails> = AsyncData.Uninitialized,
