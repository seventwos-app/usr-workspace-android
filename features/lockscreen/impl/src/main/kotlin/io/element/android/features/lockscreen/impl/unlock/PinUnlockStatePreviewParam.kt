...
open class PinUnlockStatePreviewParam : PreviewParameterProvider<PinUnlockState> {
...
open class PinUnlockStateCompactPreviewParam : PreviewParameterProvider<PinUnlockState> {
    override val values: Sequence<PinUnlockState>
        get() = sequenceOf(
            aPinUnlockState(),
            aPinUnlockState(canNavigateBack = true)
